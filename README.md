...
DRAW LINE
DRAW ROUTE
OPTIONAL: ZOOMING DYNAMICALLY

CONNECT JOURNEY TO DRAWING

GET INPUT
PASS TO ALGORITHM
CATCH ALGORITHM RESULT AND SPIT IT OUT IN TEXT

IF CLICK ON MAP, GET COORDINATE LIKE ORGANIC MAP SYSTEM

CHECK PARSER ON OTHER DATASETS AND FIX ANY ISSUES
DESIGN TESTS FOR ROUTINGENGINE
MAKE ROUTER INTERFACE/STRATEGY PATTERN

OPTIONAL: PARSE SHAPES.TXT INTO ROUTEPATHS

...
public class Config {
    ...
    public static LocalDate REF_WEEKDAY;
    public static LocalDate REF_WEEKEND;
    ...
    public static double CAR_SPEED_MPS = 40.0 / 3.6;    // 40 km/h 
    
    public static double CAR_COST_PER_METRE = 50.0 / 10000.0; // 50 SEK per 10km (includes taxes + fuel + depriciation)
    public static double FLAT_CAR_PENALTY = 150.0;            // For parking + tolls
